...
export const askLingoBuildOutputs = [
  ...
  },
  {
    ...
    layout: 'Hero + deep systems + pillars + subscriptions + ad/survey/banner surfaces + triggers + audit + Ask Lingo controls',
    sections: [
      ...
      ['Deep Audit', 'Consent, payments, ads, rewards, privacy, and operations checks before activation.'],

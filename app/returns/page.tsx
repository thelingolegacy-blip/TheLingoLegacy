const items = ['Eligibility', 'Exchanges', 'Condition requirements', 'Return support'];
...
export default function Page() {
  return (
    <section className="page-shell shell">
      ...
      <p className="hero-copy">Operational scaffold for returns policy. Final policy language should be reviewed by counsel before public launch.</p>

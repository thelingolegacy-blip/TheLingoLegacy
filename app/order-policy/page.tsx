const items = ['Product terms', 'Preorders', 'Limited drops', 'Order tracking'];
...
export default function Page() {
  return (
    <section className="page-shell shell">
      ...
      <h1>Order Policy</h1>
      <p className="hero-copy">Operational scaffold for order policy. Final policy language should be reviewed by counsel before public launch.</p>

...
for v in STAGING_VERIFY_AUTH_CMD STAGING_BASELINE_CMD STAGING_MUTATE_CLOUD_RUN_CMD STAGING_MUTATE_FIREBASE_CMD STAGING_MUTATE_WORKER_CMD STAGING_FAILURE_INJECTION_CMD STAGING_ROLLBACK_WORKER_CMD STAGING_ROLLBACK_CLOUD_RUN_CMD STAGING_ROLLBACK_FIREBASE_CMD STAGING_ROLLBACK_VERIFY_CMD; do req "$v"; done

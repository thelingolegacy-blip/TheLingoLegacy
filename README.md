...
- `/kottons-code/printables/lesson-plan/`, `/kottons-code/printables/clue-cards/`, and `/kottons-code/printables/safety-checklist/` — printer-friendly static educator resources
